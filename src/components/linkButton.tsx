...
export const LinkButton = ({ link }: Props) => {
    ...
    return (
        <button
            onClick={handleClick}
            className="w-full bg-gray-900/60 backdrop-blur-md hover:bg-gradient-to-r hover:from-cyan-900/40 hover:to-blue-900/40 border border-gray-700 hover:border-cyan-400 rounded-2xl p-4 md:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/20 hover:-translate-y-0.5 group"
        >
